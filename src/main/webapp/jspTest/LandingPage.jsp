...
<body>
    <form id="loginForm">
        ...
        <div class="wrapper">
            ...
            <a onclick="switchPage('../jspTest/LandingPageAdminPanel.jsp?inputName='+document.getElementById('UserID').value+'&keycard=30');setKeycard(30)"><span>Produktionsleder</span></a>
            <a onclick="switchPage('../jspTest/LandingPageAdminPanel.jsp?inputName='+document.getElementById('UserID').value+'&keycard=40');setKeycard(40)"><span>Laborant</span></a>
        </div>
